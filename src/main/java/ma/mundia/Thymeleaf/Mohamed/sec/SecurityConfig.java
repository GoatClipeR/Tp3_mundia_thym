package ma.mundia.Thymeleaf.Mohamed.sec;
...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsManager() {
        ...
        return new InMemoryUserDetailsManager(
                User.withUsername("user1").password(passwordEncoder().encode("utilisateur1")).roles("USER").build(),
                User.withUsername("user2").password(passwordEncoder().encode("utilisateur2")).roles("USER").build(),
                User.withUsername("admin").password(passwordEncoder().encode("admin9")).roles("USER", "ADMIN").build()
        );
    }
