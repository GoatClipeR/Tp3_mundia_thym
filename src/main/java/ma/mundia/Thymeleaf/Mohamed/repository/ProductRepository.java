package ma.mundia.Thymeleaf.Mohamed.repository; // Dossier où se trouve le repository

import ma.mundia.Thymeleaf.Mohamed.entities.Product; // J'utilise l'entité Product
