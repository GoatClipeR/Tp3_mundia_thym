package ma.mundia.Thymeleaf.Mohamed; // Je mets ma classe principale dans ce package

import ma.mundia.Thymeleaf.Mohamed.entities.Product; // J'utilise mon entité Product
import ma.mundia.Thymeleaf.Mohamed.repository.ProductRepository; // J'accède à la base via le repository
