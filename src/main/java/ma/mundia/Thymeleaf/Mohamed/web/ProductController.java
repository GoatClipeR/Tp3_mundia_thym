package ma.mundia.Thymeleaf.Mohamed.web; // Je place ici mes contrôleurs web
...
import ma.mundia.Thymeleaf.Mohamed.entities.Product; // Mon entité Product
import ma.mundia.Thymeleaf.Mohamed.repository.ProductRepository; // J'accède à la base via ce repository
